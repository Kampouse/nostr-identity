...
export const compute_commitment: (a: number, b: number) => [number, number];
...
export const verify_ownership_proof: (a: number, b: number, c: number, d: number) => [number, number, number];
