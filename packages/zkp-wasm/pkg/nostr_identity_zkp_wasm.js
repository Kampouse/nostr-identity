 ...
 * @returns {any}
 */
export function generate_ownership_proof_with_nsec(account_id, nsec_hex, nonce) {
    const ptr0 = passStringToWasm0(account_id, wasm.__wbindgen_malloc, wasm.__wbindgen_realloc);
    const len0 = WASM_VECTOR_LEN;
    ...
    const ret = wasm.generate_ownership_proof_with_nsec(ptr0, len0, ptr1, len1, ptr2, len2);
    if (ret[2]) {
...
function __wbg_get_imports() {
    ...
    return {
        __proto__: null,
        "./nostr_identity_zkp_wasm_bg.js": import0,
    };
}
...
async function __wbg_init(module_or_path) {
    ...
    if (module_or_path === undefined) {
        module_or_path = new URL('nostr_identity_zkp_wasm_bg.wasm', import.meta.url);
    }
    const imports = __wbg_get_imports();
